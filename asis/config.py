...
# Aquí estuvo MIN_PX_COMPARABLE, un piso de píxeles por debajo del cual el
# contraste entre coberturas marcaba la unidad como poco comparable. Se quitó
# porque su justificación era falsa: suponía que la media sobre pocos píxeles
# pierde resolución, y el ASI no funciona así. Medido sobre 161.685 filas
# municipio-dekad, p90 = p10 en el 100%: todos los píxeles de un municipio
# comparten el mismo valor, porque FAO calcula el índice por unidad
# administrativa y lo pinta sobre los píxeles de esa unidad. La media es ese
# valor con ocho píxeles o con cuatro mil, así que no hay imprecisión que
# advertir. El VCI sí varía dentro del municipio: ahí p90 != p10 en el 99,6%.
